...
type Pages = "about/edit" | "edit" | "newsandevents/edit" | "ourbrands" | "investorrelations/edit" | "careers/edit";
    ...
    return (
        <div className="flex xl:justify-between items-center w-full  h-10 xl:h-16 bg-white px-4 xl:px-14 xl:pt-10 pt-8">
            <div className="hidden justify-between items-center h-full w-1/3 xl:flex"> 
                <NavbarItem to="about/edit" text="About Us" />
                <NavbarItem to="edit" text="Home"/>
                <NavbarItem to="newsandevents/edit" text="News & Events"/>
            </div>
            ...
            <div className="hidden justify-between items-center h-full w-1/3 xl:flex">
                ...
                <NavbarItem to="investorrelations/edit" text="Investors"/>
                <NavbarItem to="careers/edit" text="Careers"/>
            </div>
            ...
            {/* content */}
            <Navitemphone to="edit" title="Home"/>
            <Navitemphone to="about/edit" title="About Us"/>
            <Navitemphone to="newsandevents/edit" title="News & Events"/>
            <Navitemphone to="ourbrands" title="Our Brands"/>
            <Navitemphone to="investorrelations/edit" title="Investors"/>
            <Navitemphone to="careers/edit" title="Careers"/>
            </div>
